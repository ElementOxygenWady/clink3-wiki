...
| 2019/07/24      | [`dea6b6f2`](https://code.aliyun.com/linkkit/c-sdk/commit/dea6b6f21c096b6dfc074eab4a7b8d6f33aaae92.diff)    | 如果用户直接复制SDK的HAL参考实现在Linux设备上使用, 将设备断网静置数个小时的时间, 概率性发生内存越界读写而程序崩溃   | DNS解析失败时回收socket资源
