...
| **修复日期**    | **补丁地址**                                                                                                | **症状描述**                                                                                                    | **修复备注**
|-----------------|-------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|-----------------------------------------
| 2019/07/05      | [`b1626a96`](https://code.aliyun.com/linkkit/c-sdk/commit/b1626a9665c853c947927965330083db4c405d56.diff)    | 在使用`IOT_Linkkit_Open()`接口时, 用户不能通过它的第2个结构体参数传入设备的三元组, 被传入的信息被忽略而无效     | 将被传参的信息设置到HAL中
