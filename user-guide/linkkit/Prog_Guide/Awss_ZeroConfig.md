...
0xdd, 0x45, 0xd8, 0x96, 0xe0, 0xaa, /* vendor specific start - 这一行除了第二个字段(表示长度), 其他几个字段要和本例子相同 */
...
0x01, 0x08, 0x82, 0x84, 0x8b, 0x96, 0x8c, 0x92, 0x98, 0xa4, /* supported rates */
0x32, 0x04, 0xb0, 0x48, 0x60, 0x6c, /* extended supported rates */
0xdd, 0x37, 0xd8, 0x96, 0xe0, 0xab, /* vendor specific start - 这一行除了第二个字段(表示长度), 其他几个字段要和本例子相同 */
